...
export default function AdminDashboard() {
  ...
  const menuItems = [
    ...
    { 
      ...
      color: 'indigo',
      description: 'Ангилалын дэд хэсэг'
    },
    { 
      name: 'Нүүр хуудас', 
      href: '/admin/hero', 
    ...
    { 
      name: 'Баркод жагсаалт', 
      href: '/admin/barcode', 
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5v15m3-15v15m3-15v15m3.75-15v15m3-15v15M3 4.5h18M3 19.5h18" />
        </svg>
      ),
      color: 'amber',
      description: 'Бүтээгдэхүүн ба авто-баркод'
    },
    {
      name: 'Хүргэлт',
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0H9m-3.75 0H3.375c-.621 0-1.125-.504-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />
        </svg>
      ),
      color: 'cyan',
      description: 'Хүргэлтийн ажилчдад'
    },
    {
      name: 'Борлуулалт (POS)',
      href: '/admin/sales',
      ...
      color: 'emerald',
      description: 'Бэлэн борлуулалт ба хасалт'
    },
  ]
    ...
    <main className="min-h-screen pt-[104px] bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Админ хэсэг</h1>
            <p className="text-slate-600 mt-1">Тавтай морил, {user?.full_name || 'Админ'}</p>
          </div>
          <Link 
            href="/"
            className="mt-4 sm:mt-0 inline-flex items-center gap-2 px-4 py-2 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow text-slate-700"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
          {menuItems.map((item) => (
            <Link 
              key={item.name}
              href={item.href}
              className="group bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:border-pink-200 transition-all"
            >
              <div className={`w-14 h-14 bg-${item.color}-100${item.color}-900/30 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
