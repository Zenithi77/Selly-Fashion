    ...
    <main className="min-h-screen pt-[104px] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Нууц үг сэргээх</h1>
        ...
        {submitted ? (
          <div className="bg-white rounded-2xl p-8 border border-slate-100 text-center">
            ...
            <h2 className="text-xl font-bold text-slate-900 mb-2">Имэйл илгээгдлээ!</h2>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 border border-slate-100">
            <div className="mb-6">
