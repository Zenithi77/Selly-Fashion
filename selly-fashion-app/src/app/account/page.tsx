...
export default function AccountPage() {
  ...
  const getStatusText = (status: string) => {
    const map: Record<string, string> = {
      ...
      assigned_to_courier: 'Хүргэлтийн ажилтанд хуваарилагдсан',
      picked_up: 'Хүргэлтийн ажилтан хүлээн авсан',
      in_transit: 'Замдаа',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              <Link 
                href="/shop"
                className="hidden sm:flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-pink-600 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-72 flex-shrink-0">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200/50 overflow-hidden backdrop-blur-xl">
              {/* User Profile Card */}
          ...
          <main className="flex-1 min-w-0">
            ...
            {activeTab === 'dashboard' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-white rounded-2xl p-5 border border-gray-200/50 backdrop-blur-xl">
                  ...
                  <div className="bg-white rounded-2xl p-5 border border-gray-200/50 backdrop-blur-xl">
                    ...
                    <p className="text-sm text-gray-500">Хадгалсан</p>
                  </div>
                ...
                {/* Recent Orders */}
                <div className="bg-white rounded-2xl border border-gray-200/50 backdrop-blur-xl overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-gray-200/50 hover:border-pink-300 transition-all group text-left"
                  >
                    <div className="w-12 h-12 rounded-xl bg-pink-100 flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Хадгалсан</p>
                      <p className="text-sm text-gray-500">{wishlistItems.length} бараа</p>
                    </div>
                  </button>
                </div>
              </div>
            ...
            {activeTab === 'profile' && (
              <div className="bg-white rounded-2xl border border-gray-200/50 backdrop-blur-xl overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200">
                  <h3 className="font-semibold text-gray-900">Хувийн мэдээлэл</h3>
                  <p className="text-sm text-gray-500 mt-1">Өөрийн мэдээллийг шинэчлэх</p>
                </div>
                ...
                <div className="p-6">
                  ...
                  <form onSubmit={handleUpdateProfile} className="space-y-6">
                    ...
                    <div className="flex items-center gap-6 p-6 bg-gray-50 rounded-2xl">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-900">Профайл зураг</h4>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-gray-900 focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all"
                      ...
                      <div className="md:col-span-2">
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-gray-900 focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all resize-none"
              ...
              <div className="space-y-6">
                ...
                {loading ? (
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200/50 p-12 text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Захиалга байхгүй</h3>
                  ...
                  <div className="space-y-4">
                    {orders.map((order) => (
                      <div
                        key={order.id}
                        className="bg-white rounded-2xl border border-gray-200/50 overflow-hidden hover:shadow-lg transition-shadow"
                      >
                        <div className="p-6">
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                            <div className="flex items-center gap-4">
                              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-100 to-rose-100 flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-pink-600">
                                  <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
                                </svg>
                              </div>
                              <div>
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 py-4 border-y border-gray-100">
                            <div>
                              <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Огноо</p>
                              <p className="font-medium text-gray-900">
                                {new Date(order.created_at).toLocaleDateString('mn-MN', { year: 'numeric', month: 'short', day: 'numeric' })}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Барааны тоо</p>
                              <p className="font-medium text-gray-900">
                                {order.order_items?.length || 0} бараа
                              </p>
                            </div>
                            <div>
                              <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Нийт дүн</p>
            ...
            {activeTab === 'wishlist' && (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900">Хадгалсан бараа</h2>
                    <p className="text-gray-500 mt-1">Нийт {wishlistItems.length} бараа</p>
                  </div>
                </div>
                ...
                {wishlistItems.length === 0 ? (
                  <div className="bg-white rounded-2xl border border-gray-200/50 p-12 text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Хадгалсан бараа байхгүй</h3>
                    <p className="text-gray-500 mb-6">Дуртай барааг хадгалж дараа нь худалдан аваарай</p>
                    <Link
                      href="/shop"
                      className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white font-medium rounded-xl hover:from-pink-600 hover:to-rose-600 transition-all"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {wishlistItems.map((item) => (
                      <div
                        key={item.id}
                        className="bg-white rounded-2xl border border-gray-200/50 overflow-hidden group hover:shadow-lg transition-shadow"
                      >
                        <div className="relative aspect-square bg-gray-100">
                          ...
                          <button
                            ...
                            className="absolute top-3 right-3 w-9 h-9 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center text-red-500 hover:bg-red-500 hover:text-white transition-all shadow-lg"
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                        ...
                        <div className="p-4">
                          <Link href={`/product/${item.slug}`}>
                            <h3 className="font-medium text-gray-900 hover:text-pink-600 transition-colors truncate">
                              {item.name}
                            </h3>
                          </Link>
            ...
            {activeTab === 'settings' && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-500 mt-1">Бүртгэлийн тохиргоо</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200/50 p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900">Имэйл хаяг</h4>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200/50 p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900">VIP статус</h4>
                        <p className="text-gray-500 mt-1">
                          {user?.is_vip ? (
                            <span className="text-yellow-600">⭐ VIP гишүүн - Онцгой хөнгөлөлт авах эрхтэй</span>
                          ) : (
                            'Энгийн гишүүн'
                          )}
                        </p>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-200/50 p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-gray-900">Бүртгүүлсэн огноо</h4>
                        <p className="text-gray-500 mt-1">
                  ...
                  <div className="bg-red-50 rounded-2xl border border-red-200 p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-red-700">Бүртгэлээс гарах</h4>
