...
export default function Footer() {
  return (
    <footer className="bg-white/50 border-t border-pink-100 text-slate-800">
      {/* Newsletter Section */}
          ...
          <div className="max-w-xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 bg-white/50 border border-pink-200 px-4 py-3 text-sm focus:outline-none focus:border-pink-500 focus:ring-pink-500 transition-colors rounded-full"
              />
              <button
                type="submit"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-8 lg:mb-0">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 border border-pink-200 flex items-center justify-center hover:border-pink-500 hover:text-pink-500 transition-colors rounded-full">
